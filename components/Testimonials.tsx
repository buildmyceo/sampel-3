    ...
    <section className="py-24 bg-primary-900 text-white relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t) => (
            <div key={t.id} className="bg-primary-800 p-8 rounded-xl relative border border-white/5 hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-accent-500 uppercase tracking-wide">{t.location}</p>
                  </div>
                </div>
              </div>
            </div>
